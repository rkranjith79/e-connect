                        ...
                        <div class="col-xl-9">
                            ...
                            <div class="mb-5">
                                @forelse ($data['profiles'] as $profile)
                                    <div
                                        class="border border-gray-300 rounded shadow mb-4 has-transition position-relative">
                                     ...
                                     ">
                                            ...
                                            <div class="col-md position-static d-flex align-items-center">
                                                <span class="absolute-top-right px-2 pt-1 pb-3">
                                                    <span
                                                        class="badge badge-inline badge-success">{{ $profile->code }}</span>
                                                </span>
                                        ...
                                        @else @endif
                                            ">
                                                ...
                                                <div class="col">
                                                    <a href="https://wa.me/?{{ $profile->whatsappData }}" target="_blank"
                                                        class="text-dark c-pointer">
