...
@section('content')
    ...
    <!-- Modal -->
    <!--Add RasiNavamsam -->
    <div class="modal fade" id="createRasiNavamsam" save-action="{{ route('admin.rasi_navamsam.create') }}" token="{{ csrf_token() }}">
            ...
            <div class="modal-content">
                ...
                <form method="POST" action="">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary createRasiNavamsam">Save</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form method="POST" action="">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary updateRasiNavamsam">Update</button>
                    </div>
                </form>
            </div>
        </div>
