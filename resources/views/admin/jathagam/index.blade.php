...
@section('content')
    ...
    <!-- Modal -->
    <!--Add Jathagam -->
    <div class="modal fade" id="createJathagam" save-action="{{ route('admin.jathagam.create') }}"
        token="{{ csrf_token() }}">
            ...
            <div class="modal-content">
                ...
                <form method="POST" action="">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary createJathagam">Save</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form method="POST" action="">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary updateJathagam">Update</button>
                    </div>
                </form>
            </div>
        </div>
