...
@section('content')
    ...
    <!-- Modal -->
    <!--Add RasiNakshatra -->
    <div class="modal fade" id="createRasiNakshatra" save-action="{{ route('admin.rasi_nakshatra.create') }}" token="{{ csrf_token() }}">
            ...
            <div class="modal-content">
                ...
                <form method="POST" action="">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary createRasiNakshatra">Save</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form method="POST" action="">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary updateRasiNakshatra">Update</button>
                    </div>
                </form>
            </div>
        </div>
