...
@section('content')
    ...
    <!-- Modal -->
    <!--Add SocialType -->
    <div class="modal fade" id="createSocialType" save-action="{{ route('admin.social_type.create') }}" token="{{ csrf_token() }}">
            ...
            <div class="modal-content">
                ...
                <form method="POST" action="">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary createSocialType">Save</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form method="POST" action="">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary updateSocialType">Update</button>
                    </div>
                </form>
            </div>
        </div>
