                ...
                <div class="table-data table-responsive">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <form method="POST" action="{{route('admin.price_update')}}">
                                @csrf
                                <tr>
                                    <td>{{ ($modal_data->currentPage() - 1) * $modal_data->perPage() + $loop->iteration }}
                                    </td>
                                    <td>
                                        {{-- <button class="btn-icon btn editPlan ms-1" value="{{ $data_record->id }}"><i class="fa fa-pencil" aria-hidden="true"></i>
                                        </button> --}}
                                        @if ($data_record->active == 1)
                                        <button class="btn btn-icon deactivatePlan" value="{{ $data_record->id }}"><i class="fa-solid fa-xmark" aria-hidden="true"></i>
                                        </button>
                                        @else
                                        <button class="btn btn-icon activatePlan" value="{{ $data_record->id }}"><i class="fa-solid fa-check" aria-hidden="true"></i>
                                        </button>
                                        @endif
                                    </td>
                                    ...
                                    <input type="hidden" name="id" value="{{$data_record->id}}">
                                    <td width="30%"><input type="number" name="price" id="price" required class="form-control" value="{{ $data_record->price }}"></td>
                                    <td>{{ collect($data_record->attributes)->toJson() ?? '' }}</td>
                                    <td>{{ $data_record->active == 1 ? 'Active' : 'Inactive' }}</td>
                                </tr>                            
                                <tr width="100%">
                                    <td colspan="8" style="border:none;" class="float-right" width="100%">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title" placeholder="{{ $page_data['name'] }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="expire_in_days" name="expire_in_days" placeholder="Expires in Days">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="profile_count" name="profile_count" placeholder="Profile Count">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="order_by" name="order_by" placeholder="Order By">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="edit_title" name="title" placeholder="{{ $page_data['name'] }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="edit_expire_in_days" name="expire_in_days" placeholder="Expires in Days">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="edit_profile_count" name="profile_count" placeholder="Profile Count">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="edit_price" name="price" placeholder="Price">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="edit_order_by" name="order_by" placeholder="Order By">
