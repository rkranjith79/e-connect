...
@section('content')
    ...
    <!-- Modal -->
    <!--Add Work -->
    <div class="modal fade" id="createWorkPlace" save-action="{{ route('admin.work_place.create') }}"
        token="{{ csrf_token() }}">
            ...
            <div class="modal-content">
                ...
                <form method="POST" action="">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary createWorkPlace">Save</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form method="POST" action="">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary updateWorkPlace">Update</button>
                    </div>
                </form>
            </div>
        </div>
