...
(function ($) {
        ...
        deleteUploaderFile: function () {
            $(".aiz-uploader-delete").each(function () {
                $(this).on("click", function (e) {
                    ...
                    $(".aiz-uploader-confirmed-delete").one("click", function (
                        e
                    ) {
                        e.preventDefault();
                        if (e.detail === 1) {
                ...
                if (data.length > 0) {
                    for (var i = 0; i < data.length; i++) {
                        ...
                        if (data[i].type === "image") {
                            ...
                            thumb = '<i class="fas fa-file-text"></i>';
                        }
                        var html =
    ...
    AIZ.plugins = {
        ...
        bootstrapSelect: function (refresh = "", noneSelectedText = "Select") {
        ...
        dateRange: function () {
            $(".aiz-date-range").each(function () {
                ...
                maxDate = typeof maxDate != 'undefined' ? maxDate : false;
            ...
            $.notify(
                ...
                },
                {
                    ...
                    template:
                        ...
                        '<button type="button" aria-hidden="true" data-notify="dismiss" class="close"><i class="fas fa-times"></i></button>' +
